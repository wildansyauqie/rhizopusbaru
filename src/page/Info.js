    ...
    <div className="flex flex-col w-full justify-center items-center h-screen">
      <div className="text-stone-700 dark:text-stone-300">
        <div className="flex items-center gap-2 mb-4">
          <div className={`w-2 h-2 rounded-full animate-pulse ${isDataStale ? "bg-red-600" : "bg-green-600"}`} />
          <div className="text-xs flex items-center gap-1">
            ...
            {isDataStale && (
              <div className="dropdown dropdown-end">
                <label htmlFor="modal-6" className="cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="w-4 h-4 stroke-current"
                ...
                <input type="checkbox" id="modal-6" className="modal-toggle" />
                <div className="modal modal-bottom sm:modal-middle bg-black bg-opacity-60">
                  <div className="modal-box bg-gray-100 dark:bg-slate-800">
                    <h3 className="font-bold text-lg">
                      Perangkat tidak mengirim data selama 5 menit!
                    ...
                    <p className="py-4">
                      Ini dapat disebabkan oleh perangkat yang tidak
                      tersambung dengan daya, koneksi internet, atau terjadi
                      kesalahan pada sensor.
                    </p>
                    <div className="modal-action">
                      <label htmlFor="modal-6" className="btn btn-primary">
                        Mengerti
                      </label>
                    </div>
                  </div>
